...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        ...
        fig = go.Figure()
        for v in Veh_Types:
            fig.add_trace(go.Bar(x=unemp_data[unemp_data.Vehicle_Type == v]["unemployment_rate"],
                                 y=unemp_data[unemp_data.Vehicle_Type == v]["Automobile_Sales"], name=v))
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas,x='Year',y='Automobile_Sales',title='Automobile sales (year wise)'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
        ...
        Y_chart3 = dcc.Graph(figure=px.bar(avr_vdata,x='Vehicle_Type',y='Automobile_Sales',title=f'Average Vehicles Sold by Vehicle Type in the year {year}'))
